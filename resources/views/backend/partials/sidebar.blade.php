<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        <li
            ...
            <ul class="menu-sub">
                <li class="menu-item "><a
                        class="menu-link" href="">Stream Header</a></li>

                <li class="menu-item "><a
                        class="menu-link" href="">Biography</a></li>

                <li class="menu-item "><a
                        class="menu-link" href="">Biography Profile</a>
                </li>

                <li class="menu-item "><a
                        class="menu-link" href="">Feature Album Header</a>
                </li>
                ...
                <li class="menu-item ">
                    <a class="menu-link" href="">Feature Album
                        </a>
                </li>

                <li class="menu-item "><a
                        class="menu-link" href="">Store</a></li>

                <li class="menu-item "><a
                        class="menu-link" href="">Media</a></li>

                <li class="menu-item "><a class="menu-link"
                        href="">Gallary Image</a></li>
        ...
        <li
            ...
            <ul class="menu-sub">
                <li class="menu-item "><a
                        class="menu-link" href="">Header</a></li>
                <li class="menu-item "><a
                        class="menu-link" href="">Biography</a></li>
                <li class="menu-item ">
                    <a class="menu-link" href="">Achievement
                        Header</a>
                </li>
                <li class="menu-item ">
                    <a class="menu-link" href="">Achievement
                ...
                <li class="menu-item "><a
                        class="menu-link" href="">Gallary Header</a>
                </li>
                <li class="menu-item "><a
                        class="menu-link" href="">Gallary Image</a></li>

                <li class="menu-item ">
                    <a class="menu-link" href="">Composition
                        Header</a>
                </li>
                <li class="menu-item "><a
                    class="menu-link" href="">Compositon Images</a></li>

            </ul>
        </li>

                     <!-- Company -->
                     <li class="menu-header small text-uppercase"><span class="menu-header-text">Company award And Company info</span></li>
                     <!-- Layouts -->
                     <li
                         class="menu-item  {{ Request::routeIs('company.*') || Request::routeIs('companyaward.*') ? 'active open' : '' }}">
                         <a href="javascript:void(0);" class="menu-link menu-toggle">
                         ...
                         <ul class="menu-sub">
                             <li class="menu-item {{ Request::routeIs('company.*') ? 'active' : '' }}"><a class="menu-link"
                                     href="{{ route('company.index') }}">Companies</a></li>
                             <li class="menu-item {{ Request::routeIs('companyaward.*') ? 'active' : '' }}"><a class="menu-link"
                                     href="{{ route('companyaward.index') }}">Companie awards</a></li>
                         </ul>
                     </li>
                         ...
                         <!-- Layouts -->
                         <li
                             class="menu-item  {{ Request::routeIs('system.*') || Request::routeIs('profilesetting') ? 'active open' : '' }}">
                             <a href="javascript:void(0);" class="menu-link menu-toggle">
                                 <i class="menu-icon tf-icons bx bx-crown"></i>
                             ...
                             <ul class="menu-sub">
                                 <li class="menu-item {{ Request::routeIs('system.*') ? 'active' : '' }}"><a class="menu-link"
                                         href="{{ route('system.setting') }}">Settings</a></li>
                                 <li class="menu-item {{ Request::routeIs('profilesetting') ? 'active' : '' }}"><a class="menu-link"
                                         href="{{ route('profilesetting') }}">Profile Setting</a></li>
                             </ul>
                         </li>
