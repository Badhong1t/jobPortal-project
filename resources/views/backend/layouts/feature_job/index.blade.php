...
<div class="content-wrapper">
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body">
                    <h1 class="card-title">Feature</h1>
                    <div style="display: flex;justify-content: end;"><a
                        href="{{ route('featurejob.create') }}" class="btn btn-primary mb-3">Create feature</a></div>
...
@push('script')
    ...
    <script>
        ...
        // Status Change
        function status(id) {
            var url = '{{ route('featurejob.status', ':id') }}';
            $.ajax({
                type: "GET",
        ...
        function deleteItem(id) {
            var url = '{{ route('featurejob.delete', ':id') }}';
