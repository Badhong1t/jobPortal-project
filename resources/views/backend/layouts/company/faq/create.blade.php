...
<div class="content-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Company FAQ Add</h4>
                    <p class="card-description">Setup your Company FAQ page, please <code> provide your valid data</code>.</p>
                    <form action="{{ route('for_companies.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea id="content" class="form-control  @error('description') is-invalid @enderror" rows="5" name="description"></textarea>
                            @error('description')
