                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-description">Create company Facilities, please <code>provide your valid
                                data</code>.</p>
                        <div class="mt-4">
                            <form class="forms-sample mt-4" method="POST" action="{{ route('backend.companyFacilities.update', $data->id) }}">
                                @csrf
                                @method('PUT')
                                    <div class="form-group mb-3">
                                            ...
                                            <input type="text"
                                                ...
                                                placeholder="facility_title" id="basic-default-facility_title" name="facility_title" value="{{ $data->title }}" >
