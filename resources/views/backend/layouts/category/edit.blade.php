        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('category.update',['id'=>$category->id]) }}" method="POST" enctype="multipart/form-data" class="mt-4">
                        @csrf
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="file" id="image" class="form-control dropify" name="image"  data-default-file="{{ $category->image ? asset('storage/category/'.$category->image) : asset('backend/images/image_placeholder.png') }}">
