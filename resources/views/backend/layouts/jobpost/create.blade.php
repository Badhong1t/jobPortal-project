        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('jobpost.store') }}" method="POST" enctype="multipart/form-data" class="mt-4">
                        @csrf
                        <div class="form-group mb-3">
                            <label for="job_name" class="form-lable text-uppercase">Job Name <span class="text-danger">*</span></span></label>
                            <input type="text" id="job_name" class="form-control @error('job_name') is-invalid @enderror" name="job_name">
                            @error('job_name')
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea id="job_details" class="form-control @error('job_details') is-invalid @enderror" rows="5" name="job_details"></textarea>
                            @error('job_details')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group mb-3">
                            ...
                            <textarea id="short_description" class="form-control @error('short_description') is-invalid @enderror" rows="5" name="short_description"></textarea>
