        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-description">Setup your Services , please <code> provide your valid data</code>.</p>
                    <form action="{{ route('services.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group mb-3">
                            <label for="service_name" class="form-lable text-uppercase">Service Name <span class="text-danger">*</span></label>
                            <input type="text" id="service_name" class="form-control @error('service_name') is-invalid @enderror" name="service_name">
                            @error('service_name')
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="file" id="icon_path" class="form-control dropify @error('icon_path') is-invalid @enderror" name="icon_path"  data-default-file="{{ asset('backend/images/image_placeholder.png') }}">
                            @error('icon_path')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
